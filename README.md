...
**TFT Item Mastery** — это интерактивный тренажер для игроков в Teamfight Tactics (TFT). Цель игры — помочь игрокам довести до автоматизма знание рецептов предметов, чтобы быстрее принимать решения во время реального матча.

[**Запустить игру в браузере**](https://monakez.github.io/tft-item-mastery/)
...
- **Кодинг эффект:** Автор вообще не понимает ничего в javascript и современную браузер разработку. Это чисто вайбкодинг с помощью ИИ "за вечер"
...
сделал заглушку с использованием Capacitor,но не запускал и не тестировал
